#!/usr/bin/env bash
# Run only Stage1 v32 (480x300 input, 120x75 heatmap) then eval test split.
set -euo pipefail
...
LOG="$DATASET/logs/stage1_v32_only.log"
...
exec >>"$LOG" 2>&1
log "===== STAGE1 v32 ONLY START (480x300 input, batch=64, 2x4090 DP) ====="
set_status "stage1_v32_running"
...
set_status "stage1_v32_eval_done"
log "===== STAGE1 v32 DONE + TEST EVAL ====="
